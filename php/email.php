...
$body = "<h3><b>Gracias por enviarnos su consulta</b></h3><br><br>"
        ...
        . "<b>Motivo de contacto: </b>" . $contacto . "<br><br>"
...
try {
    ...
    $mail->Host       = 'mail.hidroflores.com';                       // Set the SMTP server to send through
    $mail->SMTPAuth   = true;                                   // Enable SMTP authentication
    $mail->Username   = 'infohidroflores@hidroflores.com';           // SMTP username
    $mail->Password   = '3v4P3r0n2020';                               // SMTP password
    $mail->SMTPSecure = 'tls';         // Enable TLS encryption; `PHPMailer::ENCRYPTION_SMTPS` encouraged
    $mail->Port       = 587;                                    // TCP port to connect to, use 465 for `PHPMailer::ENCRYPTION_SMTPS` above

    //Recipients
    $mail->setFrom('infohidroflores@hidroflores.com', 'Hidroflores');
    $mail->addAddress($email);     // Add a recipient
    $mail->addAddress('hidroflores@hotmail.com');               // Name is optional
